...
public class UserStorageTests {
    ...
    */
    ...
    @Test
    void notNullIdCreationTest() {
        Throwable testException = assertThrows(ShareItIvanlidEntity.class, () ->
                testStorage.createUser(new User(1L, null, null)));
        assertEquals("New user must not have id", testException.getMessage());
    }

    @Test
    void nullIdUpdateTest() {
        Throwable testException = assertThrows(ShareItIvanlidEntity.class, () ->
                testStorage.updateUser(new User(null, null, null)));
        assertEquals("Existing user must have id", testException.getMessage());
    }
